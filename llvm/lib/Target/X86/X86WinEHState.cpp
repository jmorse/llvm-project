...
private:
  ...
  void rewriteSetJmpCall(IRBuilder<> &Builder, Function &F, CallBase &Call,
                         Value *State);
  int getBaseStateForBB(SmallDenseMap<BasicBlock *, ColorVector, 16> &BlockColors,
                        WinEHFuncInfo &FuncInfo, BasicBlock *BB);
  int getStateForCall(SmallDenseMap<BasicBlock *, ColorVector, 16> &BlockColors,
...
int WinEHStatePass::getBaseStateForBB(
    SmallDenseMap<BasicBlock *, ColorVector, 16> &BlockColors, WinEHFuncInfo &FuncInfo,
    BasicBlock *BB) {
...
void WinEHStatePass::addStateStores(Function &F, WinEHFuncInfo &FuncInfo) {
  ...
  SmallDenseMap<BasicBlock *, ColorVector, 16> BlockColors = colorEHFunclets(F);
