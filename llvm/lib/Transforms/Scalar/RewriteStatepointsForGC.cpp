...
static Value *findBasePointer(Value *I, DefiningValueMapTy &Cache,
  ...
  for (auto Pair : States) {
    ...
    BaseInst->insertBefore(I->getIterator()); // Uuuhhhh, is some kind of base pointer mangling. Should be safe.
...
// XXX XXX XXX getNextNode etc above is not debug-info-iterator safe, have skipped for now
