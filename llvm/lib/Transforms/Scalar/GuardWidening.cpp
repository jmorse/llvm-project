...
void GuardWideningImpl::makeAvailableAt(Value *V, BasicBlock::iterator Loc) const {
  auto *Inst = dyn_cast<Instruction>(V);
...
Value *GuardWideningImpl::freezeAndPush(Value *Orig, BasicBlock::iterator InsertPt) {
