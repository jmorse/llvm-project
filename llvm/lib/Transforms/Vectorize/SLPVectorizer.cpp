...
public:
  ...
  bool matchAssociativeReduction(BoUpSLP &R, Instruction *Root,
    ...
    SmallMapVector<size_t, SmallMapVector<size_t, SmallMapVector<Value *, unsigned, 2>, 2>, 8> // XXX jmorse. 100% of some allocation here is in the 1-12 range. But if we allocate a huge amount, the init will punish us...
        PossibleReducedVals;
