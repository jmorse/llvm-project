...
public:
  ...
  explicit DebugValueUser(Metadata *DebugValue) : DebugValue(DebugValue) { trackDebugValue(); }

  DebugValueUser(DebugValueUser &&X) : DebugValue(X.DebugValue) { retrackDebugValue(X); }
  DebugValueUser(const DebugValueUser &X) : DebugValue(X.DebugValue) { trackDebugValue(); }
  ...
  bool operator==(const DebugValueUser &X) const { return DebugValue == X.DebugValue; }
  bool operator!=(const DebugValueUser &X) const { return DebugValue != X.DebugValue; }
...
public:
  ...
  bool isReplaceable() const { return isTemporary() || getMetadataID() == DIArgListKind; }
