...
template <class IRUnitT> inline bool shouldConvertDbgInfo(IRUnitT &IR) { return false; }
template <> inline bool shouldConvertDbgInfo(Module &IR) { return !IR.IsNewDbgInfoFormat && UseNewDbgInfoFormat; }
template <class IRUnitT> inline void doConvertDbgInfoToNew(IRUnitT &IR) {}
template <> inline void doConvertDbgInfoToNew(Module &IR) { IR.convertToNewDbgValues(); }
