...
public:
  ...
  simple_ilist<DPValue>::iterator cloneDebugInfoFrom(const Instruction *From, bool InsertAtHead = false, std::optional<simple_ilist<DPValue>::iterator> from_here = std::nullopt);
