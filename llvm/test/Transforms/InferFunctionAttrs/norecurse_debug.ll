...
; CHECK: define dso_local void @foo{{.*}} #1
; CHECK: attributes #1 = { mustprogress nofree norecurse nosync nounwind willreturn memory(readwrite, argmem: write, inaccessiblemem: none) }
